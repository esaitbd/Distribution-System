...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <h4>Add Distribution Item</h4><hr>
            <?php
            ...
            <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>" role="form">
                ...
                <div class="form-group-sm">
                    <label for="position">Distribution Item Name</label>
        ...
        ?>
        <div class="col-md-8">
            <h4>List of Distribution Item Name</h4><hr>
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="http://192.168.45.176:192/DS/sandbox/edit_pos.php?id=<?php echo $rowPos['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                        <td><a href="http://192.168.45.176:192/DS/sandbox/delete_pos.php?id=<?php echo $rowPos['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                    </tr>
                    <?php } //End while ?>
                </table>
                    <?php $rtnReadPos->free(); ?>
