...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            ?>
                <a href="http://192.168.45.176:192/DS/sandbox/print_result.php?organization=<?php echo $org; ?>"><h3><span class="glyphicon glyphicon-print pull-right"></h3></span> </a>
                    ...
                    <h5><?php echo $rowPos['pos']; ?></h5>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-condensed table-striped">
                                <tr>
                                    <th>Access Parson Name</th>
									<th>Department</th>
									<th>Total Item Input Quantity</th>
                                    <th>Total Has been given</th>
                                </tr>
                                <?php while($rowCountVotes = $rtnReadNomOrgPos->fetch_assoc()) { ?>
                                    ...
                                    ?>
                                    <tr>
                                        <td style="width: 25%;"><?php echo $rowCountVotes['name']; ?></td>
										<td style="width: 20%;"><?php echo $rowCountVotes['course']; ?></td>
										<td style="width: 30%;"><?php echo $rowCountVotes['stud_id']; ?></td>
                                        <td style="width: 30%;"><?php echo $rtnCountVotes->num_rows; ?></td>
                                    </tr>
