...
<head>
    ...
    <title>DIU Distribution System</title>
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="stud_page.php"><span class="glyphicon glyphicon-home"></span>DIU Distribution System</a>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="voting-con">
                ...
                <h4 style="text-align: center;"><?php echo $org; ?> DIU Distribution System</h4><hr />
                        ...
                        <?php if($rtnReadNominee) { ?>
                            <div class="form-group">
                                <select name="nominee" class="form-control">
                                    <option value="">*****Select Access Parson Name*****</option>
